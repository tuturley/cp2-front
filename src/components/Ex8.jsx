...
export default function Ex8() {
  ...
  return (
    ...
    <section className="flex justify-center items-center mb-12">
      <div className="bg-white p-6 rounded-lg shadow-md w-64 text-center transition-transform duration-300 hover:-translate-y-2 hover:shadow-xl">
        <div className="text-4xl text-blue-600 mb-4 flex justify-center">
          <span className="swing"><FaShoppingCart /></span>
        </div>
